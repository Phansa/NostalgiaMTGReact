...
if __name__ == "__main__":
    ...
    unsupported_sets.add("C17")
    unsupported_sets.add("CMD")
    unsupported_sets.add("CMA")
    unsupported_sets.add("MD1")
    unsupported_sets.add("CPK")
    unsupported_sets.add("FRF_UGIN")
    unsupported_sets.add("W16")
    unsupported_sets.add("W17")
    unsupported_sets.add("PCA")
    unsupported_sets.add("DDT")
    unsupported_sets.add("E01")
    unsupported_sets.add("E02")
    unsupported_sets.add("EVG")
    unsupported_sets.add("DRB")
    unsupported_sets.add("CP1")
    unsupported_sets.add("CP2")
    unsupported_sets.add("CP3")
